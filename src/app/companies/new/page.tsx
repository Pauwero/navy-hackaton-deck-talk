...
export default function NewCompanyPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Run matchmaking so recommendations appear immediately (#24)
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="card p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl font-bold text-navy-900">Register Company</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex items-center gap-1.5 bg-navy-100 hover:bg-navy-200 text-navy-600 px-4 py-2.5 rounded-full text-sm font-medium transition-colors"
            >
              <Shield className="w-4 h-4" /> Validate
            </button>
            <button
              type="submit"
              className="flex-1 bg-accent-500 hover:bg-accent-600 text-white font-semibold py-2.5 rounded-full text-sm transition-all shadow-sm"
            >
              Submit Profile
            </button>
          </div>
